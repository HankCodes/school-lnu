...
const userSchema = new mongoose.Schema({
  ...
  firstName: {
    ...
    validate: {
      validator: function (v) {
        return (constants.REGEXP_FIRSTNAME).test(v)
      },
      message: constants.WRONG_FORMAT_FIRSTNAME
    }
  },
  notificationTypes: [String], // email or webpush
  unreadNotifications: { type: [mongoose.Schema.Types.ObjectId], ref: 'notification' },
  readNotifications: { type: [mongoose.Schema.Types.ObjectId], ref: 'notification' },
  webPushId: {type: String},
